...
//     res.render("index", { title: "Food blog - Home", categories });
//   } catch (error) {
...
exports.exploreLatest = async (req, res) => {
  try {
    ...
    res.render("explore-latest", {
      title: "Food Blog - Explore Latest",
      recipe,
    });
  } catch (error) {
    res.satus(500).send({ message: error.message || "Error Occured" });
